...
public class MOEADACD extends Algorithm {
	 ...
	 */
	public MOEADACD(Problem problem, String functionType) {
		super(problem);
		...
		do {
			...
			for (int i = 0; i < populationSize_; i++) {
				...
				Solution offSpring = (Solution) crossover_.execute(new Object[] {
						population_.get(n), parents });				// Apply mutation
				...
				updateProblem(offSpring, n, type);
